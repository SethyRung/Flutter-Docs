...
![simple-composition-example](/images/simple-composition-example.png)
...
There's more information about `StatefulWidget` objects later in this series, in the [state management lesson](https://docs.flutter.dev/get-started/fundamentals/state-management).
...
You can see your widgets render in real-time, separate from a full app. To learn more, see the [Flutter Widget Previewer](https://docs.flutter.dev/tools/widget-previewer) guide.
...
As this section of the website is evolving, we [welcome your feedback](https://google.qualtrics.com/jfe/form/SV_6A9KxXR7XmMrNsy?page=%22widgets%22)!
