...
description: A collection of notices and migration guides for breaking changes in Flutter.
navigation:
...
- `FontWeight` [also controls the weight attribute of variable fonts](https://docs.flutter.dev/release/breaking-changes/font-weight-variation)
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-contains-semantics) `containsSemantics` [in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-contains-semantics) `isSemantics`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/separated-builder-find-child-index-callback) `findChildIndexCallback` [in favor of](https://docs.flutter.dev/release/breaking-changes/separated-builder-find-child-index-callback) `findItemIndexCallback` [in](https://docs.flutter.dev/release/breaking-changes/separated-builder-find-child-index-callback) `ListView` [and](https://docs.flutter.dev/release/breaking-changes/separated-builder-find-child-index-callback) `SliverList` [separated constructors](https://docs.flutter.dev/release/breaking-changes/separated-builder-find-child-index-callback)
- [Migrating Flutter Android app to Android Gradle Plugin 9.0.0](https://docs.flutter.dev/release/breaking-changes/migrate-to-agp-9)
...
- `CupertinoDynamicColor` [wide gamut support](https://docs.flutter.dev/release/breaking-changes/wide-gamut-cupertino-dynamic-color)
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-overlay-portal-targets-root) `OverlayPortal.targetsRootOverlay`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-focusable) `SemanticsProperties.focusable` [and](https://docs.flutter.dev/release/breaking-changes/deprecate-focusable) `SemanticsConfiguration.isFocusable`
...
- [The default page transition on Android is now](https://docs.flutter.dev/release/breaking-changes/default-android-page-transition) `PredictiveBackPageTransitionBuilder`
...
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-dropdownbuttonformfield-value) `DropdownButtonFormField` [](https://docs.flutter.dev/release/breaking-changes/deprecate-dropdownbuttonformfield-value)`value` [parameter in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-dropdownbuttonformfield-value) `initialValue`
- [Deprecate app bar color](https://docs.flutter.dev/release/breaking-changes/appbar-theme-color)
- [Redesigned the](https://docs.flutter.dev/release/breaking-changes/radio-api-redesign) `Radio` [widget](https://docs.flutter.dev/release/breaking-changes/radio-api-redesign)
...
- [The](https://docs.flutter.dev/release/breaking-changes/form-semantics) `Form` [widget no longer supports being a sliver](https://docs.flutter.dev/release/breaking-changes/form-semantics)
- [Flutter now sets default](https://docs.flutter.dev/release/breaking-changes/default-abi-filters-android) `abiFilters` [in Android builds](https://docs.flutter.dev/release/breaking-changes/default-abi-filters-android)
- [Merged threads on macOS and Windows](https://docs.flutter.dev/release/breaking-changes/macos-windows-merged-threads)
- [The](https://docs.flutter.dev/release/breaking-changes/visibility-maintainfocusability) `Visibility` [widget is no longer focusable by default when](https://docs.flutter.dev/release/breaking-changes/visibility-maintainfocusability) `maintainState` [is enabled](https://docs.flutter.dev/release/breaking-changes/visibility-maintainfocusability)
- `$FLUTTER_ROOT/version` [replaced by](https://docs.flutter.dev/release/breaking-changes/flutter-root-version-file) `$FLUTTER_ROOT/bin/cache/flutter.version.json`

### Released in Flutter 3.32

- [Deprecate](https://docs.flutter.dev/release/breaking-changes/system_context_menu_controller_show) `SystemContextMenuController.show`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/expansion-tile-controller) `ExpansionTileController` [in favor of](https://docs.flutter.dev/release/breaking-changes/expansion-tile-controller) `ExpansibleController`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/navigator-complete-route) `RouteTransitionRecord.markForRemove` in favor of `RouteTransitionRecord.markForComplete`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-themedata-indicatorcolor) `ThemeData.indicatorColor` [in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-themedata-indicatorcolor) `TabBarThemeData.indicatorColor`
- [Material Theme System Updates](https://docs.flutter.dev/release/breaking-changes/material-theme-system-updates)
- `.flutter-plugins-dependencies` [replaces](https://docs.flutter.dev/release/breaking-changes/flutter-plugins-configuration) `.flutter-plugins`
...
- [Changing the default](https://docs.flutter.dev/release/breaking-changes/integration-test-default-golden-comparator) `goldenFileComparator` [for](https://docs.flutter.dev/release/breaking-changes/integration-test-default-golden-comparator) `integration_test`[s](https://docs.flutter.dev/release/breaking-changes/integration-test-default-golden-comparator)
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-inputdecoration-maintainhintheight) `InputDecoration.maintainHintHeight` [in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-inputdecoration-maintainhintheight) `InputDecoration.maintainHintSize`
...
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/web-golden-comparator) `WebGoldenComparator`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-themedata-dialogbackgroundcolor) `ThemeData.dialogBackgroundColor` [in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-themedata-dialogbackgroundcolor) `DialogThemeData.backgroundColor`
- `ImageFilter.blur` [default tile mode automatic selection](https://docs.flutter.dev/release/breaking-changes/image-filter-blur-tilemode)
- [Updated Material 3](https://docs.flutter.dev/release/breaking-changes/updated-material-3-slider) `Slider`
...
- `Color` [wide gamut support](https://docs.flutter.dev/release/breaking-changes/wide-gamut-framework)
...
- [Remove invalid parameters for](https://docs.flutter.dev/release/breaking-changes/input-decoration-collapsed) `InputDecoration.collapsed`
...
- [Generic types in](https://docs.flutter.dev/release/breaking-changes/popscope-with-result) `PopScope`
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-buttonbar) `ButtonBar` [in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-buttonbar) `OverflowBar`
- [New APIs for Android plugins that render to a](https://docs.flutter.dev/release/breaking-changes/android-surface-plugins) `Surface`
...
- [Rename](https://docs.flutter.dev/release/breaking-changes/material-state) `MaterialState` [to](https://docs.flutter.dev/release/breaking-changes/material-state) `WidgetState`
- [Introduce new](https://docs.flutter.dev/release/breaking-changes/new-color-scheme-roles) `ColorScheme` [roles](https://docs.flutter.dev/release/breaking-changes/new-color-scheme-roles)
- [Dropping support for Android KitKat](https://docs.flutter.dev/release/breaking-changes/android-kitkat-deprecation)
- [Nullable](https://docs.flutter.dev/release/breaking-changes/pageview-controller) `PageView.controller`
- [Rename](https://docs.flutter.dev/release/breaking-changes/flutter-memory-allocations) `MemoryAllocations` [to](https://docs.flutter.dev/release/breaking-changes/flutter-memory-allocations) `FlutterMemoryAllocations`
...
- [Stop generating](https://docs.flutter.dev/release/breaking-changes/asset-manifest-dot-json) `AssetManifest.json`
...
- [The](https://docs.flutter.dev/release/breaking-changes/material-3-default) `ThemeData.useMaterial3` [property is now set to true by default](https://docs.flutter.dev/release/breaking-changes/material-3-default)
- [Deprecated API removed after v3.13](https://docs.flutter.dev/release/breaking-changes/3-13-deprecations)
- [Customize tabs alignment using the new](https://docs.flutter.dev/release/breaking-changes/tab-alignment) `TabBar.tabAlignment` [property](https://docs.flutter.dev/release/breaking-changes/tab-alignment)
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/deprecate-textscalefactor) `textScaleFactor` [in favor of](https://docs.flutter.dev/release/breaking-changes/deprecate-textscalefactor) `TextScaler`
...
- [Deprecate](https://docs.flutter.dev/release/breaking-changes/describe-enum) `describeEnum` [and update](https://docs.flutter.dev/release/breaking-changes/describe-enum) `EnumProperty` [to be type strict](https://docs.flutter.dev/release/breaking-changes/describe-enum)
...
- [Deprecated](https://docs.flutter.dev/release/breaking-changes/paint-enableDithering) `Paint.enableDithering`
...
- [Added missing](https://docs.flutter.dev/release/breaking-changes/dispose) `dispose()` [for some disposable objects in Flutter](https://docs.flutter.dev/release/breaking-changes/dispose)
...
- [Removed](https://docs.flutter.dev/release/breaking-changes/ignoringsemantics-migration) `ignoringSemantics` properties
- [Deprecated](https://docs.flutter.dev/release/breaking-changes/route-information-uri) `RouteInformation.location` and its related APIs
...
- [Updated](https://docs.flutter.dev/release/breaking-changes/checkbox-fillColor) `Checkbox.fillColor` [behavior](https://docs.flutter.dev/release/breaking-changes/checkbox-fillColor)
...
- [Require one data variant for](https://docs.flutter.dev/release/breaking-changes/clipboard-data-required) `ClipboardData` [constructor](https://docs.flutter.dev/release/breaking-changes/clipboard-data-required)
...
- [Migrate](https://docs.flutter.dev/release/breaking-changes/supplemental-maybeOf-migration) `of` [to non-nullable return values, and add](https://docs.flutter.dev/release/breaking-changes/supplemental-maybeOf-migration) `maybeOf`
...
Introduced in version: 2.0.0--- Unknown node: hardBreak ---Reverted in version: 2.2.0
